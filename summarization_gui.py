# -*- coding: utf-8 -*-
"""
Created on Fri Mar 30 19:30:25 2019
...
tab_control.add(tab1, text=("Home:^20s"))
tab_control.add(tab2, text=("File:^20s"))
tab_control.add(tab3, text=("URL:^20s"))
tab_control.add(tab4, text=("Comparer :^20s"))
tab_control.add(tab5, text=("About :^20s"))
